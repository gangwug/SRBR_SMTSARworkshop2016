...
* #### caseA: 1) evenly sampled with 4h interval covering two days (from CT18 to CT62), 2) no replicate or missing value
...
* #### caseB: 1) evenly sampled with 6h interval covering two days (from CT20 to CT62), 2) no replicate 3) one missing time point at CT50
...
* #### caseC: 1) cell cycle data from yeast, 2) evenly sampled with 16min interval from 2min to 162min, 3) no replicate or missing value, 4) the expected time length for cell cycle of this kind of yeast is 85min
