...
The **meta2d** function in **MetaCycle** is designed to analyze differnt types of time-series datasets and can automatically select the proper methods to analyze different experimental designs. The implementation strategy used for **meta2d** is shown in the flow chart.
