...
* #### Check the installed RStudio and packages
    + ##### Click the RStudio icon to open it. The RStudio window will show as below (If the Console part(left bottom) does not shows 'R version 3.3.0', plese follow [README](https://mail.google.com/mail/u/0/?tab=wm#inbox) file for installing the latest R version or switch to the latest R version):
...
* #### Try to open a 'jar' file
    ...
    + ##### If these two 'jar' files could be successfully opened, you could see below two dialogs (If not, please follow [README](https://mail.google.com/mail/u/0/?tab=wm#inbox) file to install latest Java).
