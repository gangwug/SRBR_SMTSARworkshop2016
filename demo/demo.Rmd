...
* #### caseA (csv): 1) evenly sampled with 4h interval covering two days (from CT18 to CT62), 2) no replicate or missing value, 3) sampling time information is numeric value in the header
    ...
    + ##### step 4: download the analysis results (named as 'meta2d_caseA.csv') to 'result' directory
...
* #### type below command in the 'Console' window of RStudio to take a look at expression profiles of circadian transcripts by heatmap figure

```{r, warning=FALSE}
# load dplyr package
library("dplyr")
# load the function used to draw heatmap
source("~/SRBR_SMTSAworkshop-master/R/fig.R")
