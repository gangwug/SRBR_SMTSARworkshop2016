...
* #### Try to open a 'jar' file
    ...
    + ##### If these this 'jar' file is successfully opened, you will see the below dialog (If not, please follow [README](https://github.com/gangwug/SRBR_SMTSAworkshop) file to install latest Java).
