...
* ### Our experience
    + #### We understand that there may be hard time in collecting samples and preparing libries, we hope that the data analysis step may be a little easier.
    + #### The good experimental design is more important than selecting a statistical method.
    + #### Take the features of different statistical methods into the experimental design step.
    + #### There are more than 20 methods, fewer papers about method evaluation work.

* ### Look forward to your feedback and analysis experience
